...
| Domain                  | Tools |
|-------------------------|-------|
| **Languages**           | Python, C++, C, C# / .NET, TypeScript, LaTeX, Bash |
| **Machine Learning**    | PyTorch, NumPy, SciPy, Pandas, scikit-learn, Matplotlib, CUDA, Optuna, MLflow |
| **Scientific Computing**| FEM solvers, MATLAB, custom C++ kernels, IGA, Newton–Raphson |
| **Embedded & Robotics** | STM32 HAL, FreeRTOS, ROS2, Pinocchio, real-time motion control |
| **Web & Backend**       | Node.js, NestJS, Vue.js, Three.js (visualization for simulation) |
| **Systems & DevOps**    | Linux, WSL, Docker, Git, GitHub Actions, CMake |
| **Architecture**        | SOLID, OOP, Design Patterns, Clean Code, Interface-Driven DI |
